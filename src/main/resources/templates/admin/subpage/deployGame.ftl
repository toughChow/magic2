...
<div id="admin">
    ...
    <div class="ad-comment-box" id="ad-comment">
        ...
        <div class="ad-main-comment J_mainContent" id="ad-iframe">
            ...
            <form action="/deploy" class="form-horizontal" method="post">
                <div class="form-group">
                    <label class="col-sm-5 control-label">游戏名</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label class="col-sm-5 control-label">游戏商</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label class="col-sm-5 control-label">游戏背景</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label class="col-sm-5 control-label">头标logo</label>
                    <div class="col-sm-4">
                        <input type="file" class="form-control logoUrl"
                               value="">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-sm-5 control-label">游戏评分</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label class="col-sm-5 control-label">宣传图片</label>
                    <div class="col-sm-4">
                        <input type="file" class="form-control imageUrl"
                               value="">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-5 control-label">宣传图片2</label>
                    <div class="col-sm-4">
                        <input type="file" class="form-control imageUrl2"
                               value="">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-5 control-label">宣传图片3</label>
                    <div class="col-sm-4">
                        <input type="file" class="form-control imageUrl3"
                               value="">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-5 control-label">大小</label>
                    <div class="col-sm-4">
                ...
                <div class="col-sm-5 col-sm-offset-5" style="height: 80px;">
                    <button type="submit" class="btn width"
                            style=" color: #fff;background: #12A7B4;width: 80px">保存
                    </button>
                </div>
            </form>
